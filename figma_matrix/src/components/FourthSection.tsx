...
import "./styles/FourthSectionStyles.css";
const FourthSection: React.FC = () => {
  return (
    <>
      <div className="h-[894px] mt-[50px]">
        <p className="text-white font-space text-[40px] font-medium text-center mb-[20px]">
          Tokenomics
        </p>
  ...
  <svg width="300" height="300" viewBox="0 0 42 42" className="block gap-2">
  ...
  <div className="flex items-center">
    ...
    <span className="ml-1 text-white text-xs transform translate-x-50 md:text-sm md:translate-x-56 xl:translate-x-56 sm:translate-x-56 sm:translate-y-6 custom-sm:translate-x-[178px] custom-sm:translate-y-4">Marketing (5%)</span>
  </div>
  ...
  <div className="flex items-center mt-1">
    ...
    <span className="ml-1 text-white text-xs transform translate-y-20 translate-x-32 md:text-sm md:translate-x-30 xl:translate-x-30 sm:translate-x-48 custom-sm:translate-x-36 custom-sm:translate-y-24 sm:translate-y-30">Team (35%)</span>
  </div>
  ...
  <div className="flex items-center mt-1">
    ...
    <span className="ml-1 text-white text-xs transform -translate-y-8 -translate-x-48 md:text-sm md:-translate-x-60 lg:-translate-x-60 xl:-translate-x-60 sm:-translate-x-48 custom-sm:-translate-x-48 custom-sm:-translate-y-10">Liquidity Pool (90%)</span>
  </div>
</div>
