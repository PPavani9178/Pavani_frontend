  ...
  return (
    <div className="flex flex-col item-center justify-center h-[832px] mt-[70px] sm:h-[auto] hidden sm:block custom-sm:hidden">
     <div className="container m-auto ">
        ...
        <div
          className="box max-w-[608px] rounded-[16px] p-[18px]  bg-navColor"
          id="box2"
        >
          <div>
        ...
        <div
          className="box bg-navColor rounded-tl-[16px] rounded-br-[16px] rounded-tr-[56px] rounded-bl-[16px] border-1 border-navBorder p-4 h-full" // Added padding and height
          id="box4"
        >
          <div className="flex flex-col items-center justify-center h-full text-center">
            {" "}
        ...
        <div
          className="box max-w-[608px] bg-navColor border-1 border-navBorder rounded-[16px] text-white font-space text-[42px] md:text-[40px] sm:text-[36px] font-medium  flex justify-center items-center  "
          id="box6"
          style={{
      ...
      <div className="flex custom-sm:flex-col items-center gap-[10px] justify-center w-[1290px] max-w-[1070px] lg:w-[830px] custom-md:w-[1070px] md:w-[630px] 2xl:w-[1070px] custom-xl:w-[1440px] custom-sm:w-[390px] custom-sm:max-w-[390px] custom-sm:ml-[120px]  ">
        ...
        <div>
            ...
            <p className="custom-sm:ml-[70px] text-fontColor font-space text-[16px] md:text-[12px] sm:text-[8px] font-normal text-start w-[300px] max-w-[300px] h-[130px] custom-sm:w-[200px] custom-sm:text-[14px]  ">
             Find exciting new projects, events and tokens that others might be missing. Identifying promoising opportunities early, so you never miss out on the next big thing.
            </p>
          </div>
        </div>
      </div>
